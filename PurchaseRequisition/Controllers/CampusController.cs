...
namespace PurchaseRequisition.Controllers
{
    public class CampusController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Campus.Include(c => c.Address);
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,AddressID,Active")] Campus campus)
        {
            ...
            ViewData["AddressID"] = new SelectList(_context.Address, "ID", "City", campus.AddressID);
            return View(campus);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,AddressID,Active")] Campus campus)
        {
            if (id != campus.ID)
            {
                return NotFound();
